...
class API(object):
    ...
    user_timeline = bind_api(
        ...
        payload_type = 'status', payload_list = True,
        allowed_param = [ 'user_id','count', 'page','feature']
    )
    ...
    search_users = bind_api(
        ...
        require_auth = True,
        allowed_param = ['q', 'count', 'page','sort','snick','sdomain','sintro','province','city',\
                        'comorsch','base_app']
    )
    ...
    ''' trends/statuses'''
    trends_status = bind_api(
        search_api = True,
        path = '/trends/statuses.json',
        payload_type = 'json',
        allowed_param = ['trend_name', 'page', 'prepage']
    )
    """ trends """
    trends = bind_api(
        search_api = True,
